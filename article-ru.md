...
Эксперимент, как мне кажется, оказался весьма удачен. 
Хотя уже есть [список улучшений](https://github.com/xonixx/serv/issues) запланированных для версии 0.2.

Таже заранее прошу извинить, но в данный момент реализована сборка финального бинарника только под Linux. 
